...
public class abstract_function_call implements returns_value, executable {
	...
	public Object get_value(function_on_stack f) {
		...
		return new function_on_stack(f.program, (function_declaration)f.program.callable_functions.get(header), values)
				.execute();
	}

	public String toString() {
		return "call function [" +"ARGFIXTHISNOW" + "] with args [" + arguments + ']';
	}
